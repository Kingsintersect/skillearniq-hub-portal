  ...
  return (
    <div className="space-y-6 p-4 md:p-6">
      ...
      <motion.section
        ...
        className="overflow-hidden rounded-3xl border border-primary/20 bg-linear-to-br from-primary/15 via-background to-amber-500/10 p-6"
      >
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            <p className="text-xs uppercase tracking-[0.2em] text-muted-foreground">Gamification Hub</p>
            <h1 className="mt-2 text-2xl font-bold text-foreground sm:text-3xl">Level Up Your Learning</h1>
          ...
          <div className="rounded-2xl border border-border/70 bg-background/60 p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="mt-1 text-2xl font-bold text-foreground">Level {profile?.level || 1}</p>
              </div>
          ...
          <div className="rounded-2xl border border-border/70 bg-background/60 p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="mt-1 text-2xl font-bold text-foreground">{profile?.points?.toLocaleString() || 0}</p>
              </div>
              <div className="flex h-10 w-10 items-center justify-center rounded-2xl bg-primary/10 text-primary">
                <Star size={18} />
              </div>
          ...
          <div className="rounded-2xl border border-border/70 bg-background/60 p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="mt-1 text-2xl font-bold text-foreground">#{profile?.rank || 1}</p>
              </div>
              <div className="flex h-10 w-10 items-center justify-center rounded-2xl bg-primary/10 text-primary">
                <Crown size={18} />
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-2 pt-2">
                  <div className="rounded-2xl bg-blue-500/10 p-3 text-center">
                    <p className="text-sm font-semibold text-blue-600">7-Day</p>
                  ...
                  <div className="rounded-2xl bg-green-500/10 p-3 text-center">
                    <p className="text-sm font-semibold text-green-600">30-Day</p>
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <div className={`flex h-8 w-8 items-center justify-center rounded-xl ${
                          activity.type === 'badge' ? 'bg-yellow-500/10 text-yellow-600' :
                          activity.type === 'assignment' ? 'bg-blue-500/10 text-blue-600' :
                          activity.type === 'streak' ? 'bg-green-500/10 text-green-600' :
            ...
            {earnedBadges.length > 0 ? (
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
                {earnedBadges.map((badge: any) => (
                  <div
                    key={badge.id}
                    className="text-center rounded-2xl border border-amber-200 bg-gradient-to-br from-amber-50 to-amber-100 dark:from-amber-950/20 dark:to-amber-900/20 p-4"
                  >
