      ...
      <div className="max-w-8xl mx-auto">
        ...
        <Card className="bg-card border-border">
          ...
          <CardContent className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                <Label htmlFor="currentTerm" className="text-foreground">Current Term</Label>
                <Select
            ...
            <div className="space-y-2">
              <Label htmlFor="address" className="text-foreground">School Address</Label>
              <Textarea
                id="address"
        ...
        <Card className="mt-6 bg-card border-border">
          ...
          <CardContent className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                <Label className="text-foreground">Grading System</Label>
                <Select
                ...
                >
                  ...
                  <SelectContent className="bg-background border-border">
                    ...
                    <SelectItem value="letter" className="text-foreground">Letter Grade</SelectItem>
                    <SelectItem value="gpa" className="text-foreground">GPA Scale</SelectItem>
                  </SelectContent>
                </Select>
              </div>
              <div className="space-y-2">
                <Label className="text-foreground">Attendance Tracking</Label>
                <Select
                ...
                >
                  ...
                  <SelectContent className="bg-background border-border">
                    ...
                    <SelectItem value="period" className="text-foreground">Per Period</SelectItem>
                  </SelectContent>
                </Select>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                <Label className="text-foreground">Result Publication</Label>
                <Select
                ...
                >
                  ...
                  <SelectContent className="bg-background border-border">
                    <SelectItem value="immediate" className="text-foreground">Immediate</SelectItem>
                    <SelectItem value="scheduled" className="text-foreground">Scheduled</SelectItem>
                    <SelectItem value="manual" className="text-foreground">Manual Approval</SelectItem>
                  </SelectContent>
                </Select>
              </div>
              <div className="space-y-2">
                <Label className="text-foreground">Parent Access</Label>
                <Select
                ...
                >
                  ...
                  <SelectContent className="bg-background border-border">
                    <SelectItem value="enabled" className="text-foreground">Enabled</SelectItem>
                    <SelectItem value="restricted" className="text-foreground">Restricted</SelectItem>
                    <SelectItem value="disabled" className="text-foreground">Disabled</SelectItem>
                  </SelectContent>
                </Select>
              </div>
            </div>
            ...
            {/* Toggle Settings */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="flex items-center justify-between space-x-4 p-4 border border-border rounded-lg bg-background/50">
                <div className="space-y-0.5">
                  <Label htmlFor="auto-promotion" className="text-foreground">Auto Promotion</Label>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="flex items-center justify-between space-x-4 p-4 border border-border rounded-lg bg-background/50">
                <div className="space-y-0.5">
                  <Label htmlFor="email-reports" className="text-foreground">Email Reports</Label>
                  <div className="text-sm text-muted-foreground">
              ...
              <div className="space-y-2">
                <Label htmlFor="late-fee" className="text-foreground">Late Fee Percentage</Label>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                <Label htmlFor="max-absence" className="text-foreground">Maximum Absence Days</Label>
                <Input
                  id="max-absence"
                  type="number"
                  min="1"
        ...
        {/* Danger Zone */}
        <Card className="mt-6 border-destructive/50 bg-card">
          <CardHeader>
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between p-4 border border-destructive/20 rounded-lg bg-destructive/5">
              <div>
                <div className="font-semibold text-foreground">Reset All Data</div>
                <div className="text-sm text-muted-foreground">
            ...
            <div className="flex items-center justify-between p-4 border border-destructive/20 rounded-lg bg-destructive/5">
              <div>
                <div className="font-semibold text-foreground">Archive</div>
                <div className="text-sm text-muted-foreground">
                  Archive current year                </div>
              </div>
              <Button variant="outline" onClick={() => toast.info('archiving feature')} className="border-border">
                Archive Year
              </Button>
            </div>
          </CardContent>
        ...
        <div className="flex justify-between space-x-4 mt-6">
          <Button variant="outline" onClick={handleResetSettings} className="border-border">
            Reset to Defaults
          </Button>
